...
export default function Offer() {
  return (
    <section id="offer" className="relative bg-paper-bone py-[var(--space-9)] md:py-[var(--space-10)]">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-16 text-center">
        ...
        <div className="font-utility text-base md:text-lg text-ink/70 space-y-2 mb-10">
          <p className="text-ink text-2xl md:text-3xl font-semibold">{formatPrice()}</p>
